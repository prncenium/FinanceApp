  ...
  return (
    <div className="w-full bg-gray-100 p-6 min-h-screen">
      ...
      <div className="space-y-4">
        {budgets.length === 0 ? (
          <p className="text-center text-gray-500 bg-white p-4 rounded-md border border-gray-300">
              ...
              <div key={budget._id} className="bg-white p-4 border border-gray-300 rounded-lg">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <div className="text-sm text-gray-600">
                    {/* --- FIX 1: Corrected Date Logic --- */}
                    {budget.period ? budget.period.charAt(0).toUpperCase() + budget.period.slice(1) : 'Monthly'} • {new Date(budget.createdAt || Date.now()).getFullYear()}
                  </div>
                </div>
                ...
                <div className="w-full bg-gray-200 rounded-full h-3 mb-2">
                  <div
                    ...
                    // --- FIX 2: Corrected Template Literal ($ instead of ₹) ---
